...
def load_pretrained_model(model_name='ir50'):
    ...
    statedict = torch.load(ckpt_path, map_location=torch.device('cpu'))['state_dict']
...
if __name__ == '__main__':
    ...
    # load model
    adaface_models = {
        'my_arcface_ir18_casia': ["../pretrained/my_arcface_ir18_casia.ckpt", 'ir_18'],
        'my_adaface_ir18_casia': ["../pretrained/my_adaface_ir18_casia.ckpt", 'ir_18'],
        'finetuned_arcface_ir18_casia': ["../pretrained/finetuned_arcface_ir18_casia.ckpt", 'ir_18'],
        'finetuned_adaface_ir18_casia': ["../pretrained/finetuned_adaface_ir18_casia.ckpt", 'ir_18'],
        ...
        'ir50_finetuned': ["../experiments/finetune_ir50_ms1mv2_adaface_03-25_1/epoch=1-step=244.ckpt", 'ir_50'],
        'ir101_finetuned': ["../experiments/finetune_ir101_ms1mv2_adaface_03-25_0/epoch=5-step=732.ckpt", 'ir_101'],
    }
